function [Csig,Cbak,Covl,llr_mean,segSNR,wss_dist,pesq_mos,lsd,wSNR]= composite(cleanFile, enhancedFile);
...
% -------compute the LSD-----------------------------------
[lsd,~] = IsegLSD(data1, data2); 

%---------compute the WSNR---------------------------------
wSNR = nanmedian(IsegWSNR(data1, data2));

% fprintf('\n LLR=%f   SNRseg=%f   WSS=%f   PESQ=%f  LSD=%f  WSNR=%f \n',llr_mean,segSNR,wss_dist,pesq_mos,lsd,wSNR);
